...
class Env():
    ...
    def getState(self, scan):
        global scan_range    #将scan_range申明为全局变量
        scan_range = []
        yaw = self.yaw
    ...
    def setReward(self, done, arrive):
        ...
        reward = 500.*distance_rate - 1 \
                    ...
                    + 10*(self.linear_vel_diff - 0.125)   #鼓励线速度提高，增加探索
        ...
        if arrive:
            ...
            try:
                ...
                # self.goal_position.position.x = random.uniform(-9, 9)
                # self.goal_position.position.y = random.uniform(-9, 9)
    ...
    def step(self, action, past_action):
        ...
        self.linear_vel_diff = linear_vel
        vel_cmd = Twist()
        ...
        # self.write_actions(self.position, action)
